<template>
  <div>
    ...
    <input type="button"
           value="Save"
           @click="save"
           :disabled="isDisable(name, currency)"/>
    <p id="error_line"
       style="display: none;">Account already exists!</p>
    <p id="rec_line"
       style="display: none;">You have deleted this account. Try to recover it from the line above.</p>
